...
class Proxy
  ...
  def messages
    return @methods_called.keys
  end
  
  def called?(method_name)
    return @methods_called[method_name] != nil
  end
  
  def number_of_times_called(method_name)
    return @methods_called[method_name] if @methods_called[method_name]!=nil
    return 0
  end
  ...
  def method_missing(method_name, *args, &block)
      ...
      if @methods_called[method_name] != nil
        @methods_called[method_name] = @methods_called[method_name] + 1
      else
